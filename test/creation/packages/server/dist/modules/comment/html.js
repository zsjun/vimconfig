...
exports.getReplyCommentHTML = exports.getNewCommentHTML = void 0;
const date_util_1 = require("../../utils/date.util");
exports.getNewCommentHTML = ({ systemLogo, systemTitle, systemFavicon, systemUrl, adminSystemUrl, adminName, comment, }) => {
    return `
  <table
  id="table-parent"
...
exports.getReplyCommentHTML = ({ systemLogo, systemTitle, systemFavicon, systemUrl, replyUserName, commentHostUrl, }) => {
    return `
  <table
  id="table-parent"
  style="background-color:#ffffff; border:0 none; border-collapse:collapse; mso-table-lspace:0; mso-table-rspace:0"
