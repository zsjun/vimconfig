...
module.exports = __webpack_require__("1rOl");
...
/* harmony import */ var antd_lib_popover_style__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("/xgg");
...
/* harmony import */ var antd_lib_popover__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("27qp");
...
/* harmony import */ var antd_lib_button_style__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("MaXC");
...
/* harmony import */ var antd_lib_avatar_style__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__("W93S");
...
/* harmony import */ var antd_lib_avatar__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__("9ubE");
...
/* harmony import */ var antd_lib_popconfirm_style__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__("eOfH");
/* harmony import */ var antd_lib_popconfirm_style__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(antd_lib_popconfirm_style__WEBPACK_IMPORTED_MODULE_10__);
/* harmony import */ var antd_lib_popconfirm__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__("QghY");
...
/* harmony import */ var antd_lib_message_style__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__("tL+A");
...
/* harmony import */ var antd_lib_message__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__("3PsY");
...
/* harmony import */ var classnames__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__("K2gz");
...
/* harmony import */ var react_sortable_hoc__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__("2iaJ");
/* harmony import */ var react_sortable_hoc__WEBPACK_IMPORTED_MODULE_18___default = /*#__PURE__*/__webpack_require__.n(react_sortable_hoc__WEBPACK_IMPORTED_MODULE_18__);
/* harmony import */ var array_move__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__("sGDL");
/* harmony import */ var array_move__WEBPACK_IMPORTED_MODULE_19___default = /*#__PURE__*/__webpack_require__.n(array_move__WEBPACK_IMPORTED_MODULE_19__);
/* harmony import */ var _providers_knowledge__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__("XnLC");
/* harmony import */ var _components_Editor__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__("gFvc");
/* harmony import */ var _components_KnowledgeSettingDrawer__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__("tjNU");
/* harmony import */ var _hooks_useForceUpdate__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__("mMs/");
/* harmony import */ var _hooks_useToggle__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__("M7TQ");
/* harmony import */ var _index_module_scss__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__("Yoxv");
/* harmony import */ var _index_module_scss__WEBPACK_IMPORTED_MODULE_25___default = /*#__PURE__*/__webpack_require__.n(_index_module_scss__WEBPACK_IMPORTED_MODULE_25__);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__("MLMA");
...
const DragHandle = Object(react_sortable_hoc__WEBPACK_IMPORTED_MODULE_18__["SortableHandle"])(() => __jsx("span", {
  style: {
    cursor: 'move'
  }
}, __jsx(_ant_design_icons__WEBPACK_IMPORTED_MODULE_17__["MenuOutlined"], null)));

const Page = ({
  id,
  knowledge: defaultKnowledge
}) => {
  const forceUpdate = Object(_hooks_useForceUpdate__WEBPACK_IMPORTED_MODULE_23__[/* useForceUpdate */ "a"])();
  const $container = Object(react__WEBPACK_IMPORTED_MODULE_14__["useRef"])();
  const {
    0: loading,
    1: setLoading
  } = Object(react__WEBPACK_IMPORTED_MODULE_14__["useState"])(false);
  const [popVisible, togglePopVisible] = Object(_hooks_useToggle__WEBPACK_IMPORTED_MODULE_24__[/* useToggle */ "a"])(false);
  const [settingVisible, toggleSettingVisible] = Object(_hooks_useToggle__WEBPACK_IMPORTED_MODULE_24__[/* useToggle */ "a"])(false);
  const {
    0: knowledge,
    1: setKnowledge
  } = Object(react__WEBPACK_IMPORTED_MODULE_14__["useState"])(defaultKnowledge);
  const {
    0: newTitle,
    1: setNewTitle
  ...
  const {
    0: currentIndex,
    1: setCurrentIndex
  } = Object(react__WEBPACK_IMPORTED_MODULE_14__["useState"])(-1);
  const {
    0: chapters,
    1: setChapters
  } = Object(react__WEBPACK_IMPORTED_MODULE_14__["useState"])(knowledge.children || []);
  const currentChapter = chapters[currentIndex] || null;
  const deleteKnowledge = Object(react__WEBPACK_IMPORTED_MODULE_14__["useCallback"])(idx => {
    const handle = () => {
    ...
    if (target.id) {
      _providers_knowledge__WEBPACK_IMPORTED_MODULE_20__[/* KnowledgeProvider */ "a"].deleteKnowledge(target.id).then(() => {
        handle();

        antd_lib_message__WEBPACK_IMPORTED_MODULE_13___default.a.success('已保存');
      });
    } else {
      handle();
    }
  }, [chapters, currentIndex, forceUpdate]);
  const SortableItem = Object(react_sortable_hoc__WEBPACK_IMPORTED_MODULE_18__["SortableElement"])(({
    value: idx
  }) => __jsx("div", {
    key: idx,
  ...
  }, __jsx(DragHandle, null), __jsx("span", null, chapters[idx].title), __jsx(antd_lib_popconfirm__WEBPACK_IMPORTED_MODULE_11___default.a, {
    title: "\u786E\u8BA4\u5220\u9664?",
  ...
  const SortableList = Object(react_sortable_hoc__WEBPACK_IMPORTED_MODULE_18__["SortableContainer"])(({
    items
  }) => {
    return __jsx("div", {
      className: _index_module_scss__WEBPACK_IMPORTED_MODULE_25___default.a.menu
  ...
  const onSortEnd = Object(react__WEBPACK_IMPORTED_MODULE_14__["useCallback"])(({
    oldIndex,
    newIndex
  }) => {
    if (currentIndex > -1) {
    ...
    setChapters(chapters => {
      return array_move__WEBPACK_IMPORTED_MODULE_19___default()(chapters, oldIndex, newIndex);
    });
  }, [currentIndex]);
  const createNewKnowledge = Object(react__WEBPACK_IMPORTED_MODULE_14__["useCallback"])(() => {
    ...
    togglePopVisible();
    forceUpdate();
    Promise.resolve().then(() => Object(_utils__WEBPACK_IMPORTED_MODULE_26__[/* scrollToBottom */ "e"])($container.current));
  }, [newTitle, chapters, forceUpdate, togglePopVisible]);
  const patchKnowledge = Object(react__WEBPACK_IMPORTED_MODULE_14__["useCallback"])(patch => {
    if (currentIndex < 0) {
      return;
    }
  ...
  const save = Object(react__WEBPACK_IMPORTED_MODULE_14__["useCallback"])(() => {
    ...
    const promises = chapters.map(chapter => {
      if (chapter.parentId) {
        return _providers_knowledge__WEBPACK_IMPORTED_MODULE_20__[/* KnowledgeProvider */ "a"].updateKnowledge(chapter.id, chapter);
      }

      return _providers_knowledge__WEBPACK_IMPORTED_MODULE_20__[/* KnowledgeProvider */ "a"].createChapters([_objectSpread(_objectSpread({}, chapter), {}, {
        parentId: id
      })]);
  ...
  return __jsx("div", {
    className: _index_module_scss__WEBPACK_IMPORTED_MODULE_25___default.a.wrapper
  }, __jsx("aside", null, __jsx("header", null, __jsx("div", null, __jsx(antd_lib_popconfirm__WEBPACK_IMPORTED_MODULE_11___default.a, {
    title: "\u786E\u8BA4\u5173\u95ED\uFF1F\u5982\u679C\u6709\u5185\u5BB9\u53D8\u66F4\uFF0C\u8BF7\u5148\u4FDD\u5B58\u3002",
    onConfirm: () => next_router__WEBPACK_IMPORTED_MODULE_15___default.a.push('/knowledge'),
    onCancel: () => null,
    okText: "\u786E\u8BA4",
    cancelText: "\u53D6\u6D88",
  ...
  }, __jsx(_ant_design_icons__WEBPACK_IMPORTED_MODULE_17__["CloseOutlined"], null)), __jsx("div", null, __jsx(antd_lib_avatar__WEBPACK_IMPORTED_MODULE_9___default.a, {
    shape: "square",
    src: knowledge.cover
  }), __jsx("span", {
    style: {
  ...
  }, knowledge.title)), __jsx(_ant_design_icons__WEBPACK_IMPORTED_MODULE_17__["SettingOutlined"], {
    style: {
      cursor: 'pointer'
    },
    onClick: toggleSettingVisible
  }), __jsx(_components_KnowledgeSettingDrawer__WEBPACK_IMPORTED_MODULE_22__[/* KnowledgeSettingDrawer */ "a"], {
    visible: settingVisible,
    toggleVisible: toggleSettingVisible,
    book: knowledge,
    onOk: setKnowledge
  })), __jsx("div", null, __jsx(antd_lib_button__WEBPACK_IMPORTED_MODULE_7___default.a, {
    style: {
      width: '100%'
    },
    onClick: save,
    loading: loading
  }, "\u4FDD\u5B58")), __jsx("div", null, __jsx("span", null, chapters.length, "\u7BC7\u6587\u7AE0"), __jsx(antd_lib_popover__WEBPACK_IMPORTED_MODULE_3___default.a, {
    content: __jsx("div", {
      style: {
        display: 'flex'
      }
    ...
    icon: __jsx(_ant_design_icons__WEBPACK_IMPORTED_MODULE_17__["PlusOutlined"], null),
    size: "small"
  }, "\u65B0\u5EFA"))), __jsx(antd_lib_divider__WEBPACK_IMPORTED_MODULE_1___default.a, {
    style: {
      margin: '16px 0'
    }
  })), __jsx("main", {
    ...
    useDragHandle: true,
    lockAxis: 'y'
  }))), __jsx("main", null, currentChapter ? __jsx(_components_Editor__WEBPACK_IMPORTED_MODULE_21__[/* Editor */ "a"], {
    defaultValue: currentChapter && currentChapter.content || '',
    onChange: patchKnowledge
  }) : __jsx("div", {
    className: _index_module_scss__WEBPACK_IMPORTED_MODULE_25___default.a.helper
  }, "\u8BF7\u65B0\u5EFA\u7AE0\u8282\uFF08\u6216\u8005\u9009\u62E9\u7AE0\u8282\u8FDB\u884C\u7F16\u8F91\uFF09")));
};
...
Page.getInitialProps = async ctx => {
  ...
  const knowledge = await _providers_knowledge__WEBPACK_IMPORTED_MODULE_20__[/* KnowledgeProvider */ "a"].getKnowledge(id);
  return {
    id,
    knowledge
  };
...
class KnowledgeProvider {
  ...
  static createBook(data) {
    return _http__WEBPACK_IMPORTED_MODULE_0__[/* httpProvider */ "a"].post('/knowledge/book', data);
  }
  /**
   * 创建知识库章节
   * @param data
  ...
  static createChapters(data) {
    return _http__WEBPACK_IMPORTED_MODULE_0__[/* httpProvider */ "a"].post('/knowledge/chapter', data);
  }
  /**
   * 删除文章
   * @param id
  ...
  static async deleteKnowledge(id) {
    return _http__WEBPACK_IMPORTED_MODULE_0__[/* httpProvider */ "a"].delete(`/knowledge/${id}`);
  }
  /**
   * 更新文章
   * @param id
  ...
  static async updateKnowledge(id, data) {
    return _http__WEBPACK_IMPORTED_MODULE_0__[/* httpProvider */ "a"].patch(`/knowledge/${id}`, data);
  }
  /**
   * 获取所有知识库（不包含章节）
   */
  ...
  static async getKnowledges(params = {}) {
    return _http__WEBPACK_IMPORTED_MODULE_0__[/* httpProvider */ "a"].get('/knowledge', {
      params
    });
  }
  /**
  ...
  static async getKnowledge(id) {
    return _http__WEBPACK_IMPORTED_MODULE_0__[/* httpProvider */ "a"].get(`/knowledge/${id}`);
  }
  /**
   * 更新知识阅读量
   * @param id
  ...
  static async updateKnowledgeViews(id) {
    return _http__WEBPACK_IMPORTED_MODULE_0__[/* httpProvider */ "a"].post(`/knowledge/${id}/views`);
  }
...
module.exports = {
	"wrapper": "_3y-zX0aZfFR_h_85Pb4UUy",
	"helper": "_3GFR80Z1xa2wD916_cENyg"
};
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return KnowledgeSettingDrawer; });
/* harmony import */ var antd_lib_drawer_style__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("dc+4");
/* harmony import */ var antd_lib_drawer_style__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(antd_lib_drawer_style__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var antd_lib_drawer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("wvHv");
/* harmony import */ var antd_lib_drawer__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(antd_lib_drawer__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var antd_lib_button__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("eGmO");
/* harmony import */ var antd_lib_button__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(antd_lib_button__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var antd_lib_switch_style__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("LGkk");
/* harmony import */ var antd_lib_switch_style__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(antd_lib_switch_style__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var antd_lib_switch__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("+PSA");
...
/* harmony import */ var antd_lib_message_style__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__("tL+A");
/* harmony import */ var antd_lib_message_style__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(antd_lib_message_style__WEBPACK_IMPORTED_MODULE_8__);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__("cDcd");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_10__);
/* harmony import */ var _hooks_useToggle__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__("M7TQ");
/* harmony import */ var _hooks_useAsyncLoading__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__("7LGd");
/* harmony import */ var _providers_knowledge__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__("XnLC");
/* harmony import */ var _components_FileSelectDrawer__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__("JT4/");
/* harmony import */ var _components_Upload__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__("NVXP");
...
const KnowledgeSettingDrawer = ({
  ...
  const [fileVisible, toggleFileVisible] = Object(_hooks_useToggle__WEBPACK_IMPORTED_MODULE_11__[/* useToggle */ "a"])(false);
  const [createBookApi, createLoading] = Object(_hooks_useAsyncLoading__WEBPACK_IMPORTED_MODULE_12__[/* useAsyncLoading */ "a"])(_providers_knowledge__WEBPACK_IMPORTED_MODULE_13__[/* KnowledgeProvider */ "a"].createBook);
  const [updateBookApi, updateLoading] = Object(_hooks_useAsyncLoading__WEBPACK_IMPORTED_MODULE_12__[/* useAsyncLoading */ "a"])(_providers_knowledge__WEBPACK_IMPORTED_MODULE_13__[/* KnowledgeProvider */ "a"].updateKnowledge);
  const {
    0: title,
    1: setTitle
  } = Object(react__WEBPACK_IMPORTED_MODULE_10__["useState"])(book && book.title || '');
  const {
    0: summary,
    1: setSummary
  } = Object(react__WEBPACK_IMPORTED_MODULE_10__["useState"])(book && book.summary || '');
  const {
    0: isCommentable,
    1: setCommentable
  } = Object(react__WEBPACK_IMPORTED_MODULE_10__["useState"])(book && book.isCommentable || true);
  const {
    0: cover,
    1: setCover
  } = Object(react__WEBPACK_IMPORTED_MODULE_10__["useState"])(book && book.cover || '');
  const ok = Object(react__WEBPACK_IMPORTED_MODULE_10__["useCallback"])(() => {
    const data = {
      title: title.trim(),
      cover,
    ...
    promise.then(res => {
      antd_lib_message__WEBPACK_IMPORTED_MODULE_9___default.a.success(isUpdate ? '更新成功' : '创建成功');
  ...
  return __jsx(antd_lib_drawer__WEBPACK_IMPORTED_MODULE_1___default.a, {
    ...
    htmlFor: "title"
  }, "\u540D\u79F0"), __jsx("div", null, __jsx(antd_lib_input__WEBPACK_IMPORTED_MODULE_7___default.a, {
    id: "title",
    value: title,
    ...
    htmlFor: "summary"
  }, "\u63CF\u8FF0"), __jsx("div", null, __jsx(antd_lib_input__WEBPACK_IMPORTED_MODULE_7___default.a.TextArea, {
    autoSize: {
      minRows: 3,
      maxRows: 6
    },
    ...
    htmlFor: "title"
  }, "\u8BC4\u8BBA"), __jsx("div", null, __jsx(antd_lib_switch__WEBPACK_IMPORTED_MODULE_5___default.a, {
    ...
    htmlFor: "upload"
  }, "\u5C01\u9762"), __jsx("div", null, __jsx(_components_Upload__WEBPACK_IMPORTED_MODULE_15__[/* Upload */ "a"], {
    style: {
      width: '100%',
      minHeight: 160
    },
  ...
  }) : null), __jsx(antd_lib_input__WEBPACK_IMPORTED_MODULE_7___default.a, {
    value: cover,
    style: {
      marginTop: 12
    }
  ...
  }, "\u9009\u62E9\u6587\u4EF6"), cover && __jsx(antd_lib_button__WEBPACK_IMPORTED_MODULE_3___default.a, {
    style: {
      marginTop: 12,
      marginLeft: 12
    },
    danger: true,
    onClick: () => setCover('')
  }, "\u79FB\u9664"))), __jsx(_components_FileSelectDrawer__WEBPACK_IMPORTED_MODULE_14__[/* FileSelectDrawer */ "a"], {
    visible: fileVisible,
  ...
  }, "\u53D6\u6D88"), __jsx(antd_lib_button__WEBPACK_IMPORTED_MODULE_3___default.a, {
    style: {
      marginLeft: 8
    },
    type: "primary",
